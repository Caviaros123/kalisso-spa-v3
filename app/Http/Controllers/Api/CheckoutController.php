...
class CheckoutController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //init
        $getAddress = [];
        $cartItem = DB::table('tbl_shopping_cart')->where('user_id', Auth::id())->get() ?? $request->cartItemList;
        ...
        foreach($cartItem as $keys => $v) {
            $cartItem[$keys]['product_id'] = $v['id'];
            $cartItem[$keys]['qty'] = $v['qty'];
        }

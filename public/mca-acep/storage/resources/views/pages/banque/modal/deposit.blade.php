...
<div class="modal fade" id="modal-deposit">
    <div class="modal-dialog ">
        <div class="modal-content " style="background-color: #2d77ff; color: white">
            ...
            <form action="{{route('bank.deposit') }}" method="POST" role="form">
                @csrf
                @method('PUT')
                <div class="modal-body ">
                    <div class="s2-example">
                        <label>Choisir le membre</label><br>
                        <select id="deposit_get_user" name="user_id" class="js-example-basic-single">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group d-flex" >
                            <div class="col-6">
                                ...
                                <h2 id="deposit_user_amount_courant" class="form-control bg rounded shadow b h1 text-danger">0 Fcfa</h2>
                            </div>
                            <div class="col-6">
                                <label>Solde Epargne:</label>
                                <h2 id="deposit_user_amount_epargne" class="form-control bg rounded shadow b h1 text-danger">0 Fcfa</h2>
                            </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group d-flex">
                            <div class="col-6">
                                <label for="deposit_type1" class="container">Compte courant
                                    <input type="radio" name="type" value="courant" id="deposit_type1" checked required>
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                            <div class="col-6">
                                <label for="deposit_type2" class="container">Compte epargne
                                    <input type="radio" name="type" value="epargne" id="deposit_type2"  required>
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="form-group mb-3">
                        <label>Montant du dépot</label>
                        <div class="input-group">
                            <input type="number" name="amount" id="deposit_amount" class="form-control-lg form-control"  placeholder="Minimum= 500 Fcfa" min="500" max="2000000" required>
                            <div class="input-group-append">
                                <div class="input-group-text">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <div class="col-4">
                        ...
                        <button type="submit" id='deposit_submit' name="submit" value="bank_deposit" required="required" class="btn btn-success btn-block">Créer</button>
                    </div>
                </div>
            </form>
            @else
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group d-flex" >
                            <div class="col-6">
                                <label>Solde Courant:</label>
                                <h2 id="group_deposit_user_amount_courant" class="form-control bg rounded shadow b h1 text-danger">0 Fcfa</h2>
                            </div>
                            <div class="col-6">
                                <label>Solde Epargne:</label>
                                <h2 id="group_deposit_user_amount_epargne" class="form-control bg rounded shadow b h1 text-danger">0 Fcfa</h2>
                            </div>
                            <!-- <input type="number" minlength="3" id="user_amount" value="" min="500" name="user_amount" class="form-control" placeholder="Soldes" required> -->
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        <label>Montant du dépot</label>
                        <div class="input-group">
                            <input type="number" name="amount" id="deposit_amount" class="form-control-lg form-control"  placeholder="Minimum= 500 Fcfa" min="500" max="5000000" required>
                            <div class="input-group-append">
                                <div class="input-group-text">
                                    <span class="fas fa-money-bill"></span>
                                </div>
...
<script type="text/javascript">
    ...
    $(".get_group_amount ").change(function(){
        ...
        .then(function (response) {
            if (response.data.data) {
                ...
                $("#group_deposit_user_amount_courant").text(courant+ " Fcfa");
                $("#group_deposit_user_amount_epargne").text(epargne+ " Fcfa");
    ...
    //BANK ACCOUNT
    $("#deposit_get_user").change(function(){
        var id = $(this).val();
        ...
        .then(function (response) {
            if (response.data.data < 500) {
                ...
                $("#deposit_user_amount_courant").text(courant+ " Fcfa");
                $("#deposit_user_amount_epargne").text(epargne+ " Fcfa");

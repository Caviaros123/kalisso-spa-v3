        ...
        <div class="row">
          ...
          <main class="col-md-6">
            <article class="product-info-aside">
              ...
              <div class="rating-wrap py-3 row-sm">
                <small
                ...
                >
                <small
                  class="label-rating text-danger mr-3"
                ...
                <small class="badge badge-warning pr-3">
                  <i class="fa fa-map-marker-alt pr-2 pl-2"></i>
                  {{ product.location || 'Brazzaville'
                   }}
                </small>
              </div>
              <!-- rating-wrap.// -->

...
// const base url
const baseUrl = "https://kalisso.com";
...
export const store = new Vuex.Store({
    state: {
        ...
        allStore: [],
        lastSeenProducts:
            JSON.parse(localStorage.getItem("lastSeenProducts")) || [],
    ...
    mutations: {
        ...
        pushToLastSeenProducts(state, data) {
            ...
            localStorage.setItem(
                "lastSeenProducts",
                JSON.stringify(state.lastSeenProducts)
            );
        },
        AllStore(state, data) {
    ...
    actions: {
        updateProfile({ commit }, data) {
            return new Promise((resolve, reject) => {
                axios
                    .put("/account/user/update/profile/global", data)
                    .then((response) => {

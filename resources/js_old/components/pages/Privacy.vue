<template>
  <div class="px-0 page-wrapper">
    ...
    <section class="section-pagetop bg-gray">
      <div class="container">
        <h1 class="title-page text-muted display-4 text-center">
          Terms et conditions d'utilisations
        </h1>
      </div>
      <!-- container //  -->
    </section>
    ...
    <section>
      <div class="container p-5">
        <!-- <div class="padding-y-sm">
          <img src="/kalisso.png" class="pb-4 pt-3 w-25" />
        </div> -->

       <div class="padding-y h4 text-muted">
            Privacy Policy
       </div>

        <p>
          Introduction Our privacy policy will help you understand what
          information we collect at Kalisso, how Kalisso uses it, and what
          choices you have. Kalisso built the Kalisso app as a free app. This
          SERVICE is provided by Kalisso at no cost and is intended for use as
          is. If you choose to use our Service, then you agree to the collection
        ...
        <p>
          ...
          identifiable information, including but not limited to users name,
          email address, gender, location, pictures. The information that we
        ...
        <p>
          Location Information Some of the services may use location information
          transmitted from users' mobile phones. We only use this information
          within the scope necessary for the designated service.
        </p>

        <p>
          Device Information We collect information from your device in some
          cases. The information will be utilized for the provision of better
          service and to prevent fraudulent acts. Additionally, such information
        ...
        <p>
          Children’s Privacy This Services do not address anyone under the age

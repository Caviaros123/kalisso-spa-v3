    ...
    <div class="page-wrapper">
      <section class="section-content padding-y-md">
        ...
        <p class=" text-muted h5 mt-3">Devenez vendeur particulier ou professionnel grâce à notre
          ...
          <div class="card rounded mt-2 shadow mb-4">
            <form-wizard
              validate-on-back
              ref="wizard"
              error-color="#ff4949"
          ...
          <div class="mx-auto p-4 text-center align-items-center text-light">
            <div class="row">
              <div class="col-md-4">
                <a class="text-dark" href="/">&copy; Kalisso LLC.</a>
              </div>
              <div class="col-md-4">
...
import StepOne from './create_stepper/step_1.vue';
import StepTwo from './create_stepper/step_2.vue';
import StepTree from './create_stepper/step_3.vue';

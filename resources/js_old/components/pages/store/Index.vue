        ...
        <div class="container  my-5 px-2 ">
            ...
            <section class="container pb-5">
                ...
                <div class="padding-y-sm" align="center">
                  <router-link :to="{name: 'plan.create.store'}" class="btn btn-danger btn-lg round b p-2 ml-3 p-3">METTRE EN VENTE</router-link>
                </div>
            </section>
            ...
            <section class="container  row p-5">
                ...
                <div class="col-7 pb-5 text-left ">
                    ...
                    <p class="h6 ">
                        <span class="h3 text-danger mr-3">1.</span> Décidez de ce que vous voulez vendre Plus de 20 catégories sont ouvertes à tous les vendeurs. Certaines ne sont ouvertes qu’aux vendeurs professionnels.
            ...
            <section class="container  row p-5">
                ...
                <div class="col-7 pb-5 text-left ">
                    ...
                    <p class="h6 ">
                        <span class="h3 text-danger mr-3">2.</span> Avec deux plans de vente distincts sur Kalisso, vous pouvez vendre à l’unité ou par milliers. Le plan professionnel vous permet de vendre une quantité illimitée de produits pour un abonnement
                        mensuel de 5000 Fcfa (hors TVA). Pour les particuliers, pas d’abonnement mensuel mais une commission de 10% (hors TVA) par article vendu. Les professionnels et les particuliers paient des frais de vente supplémentaires dès qu’un article
                        est vendu.
            ...
            <section class="container  row p-5">
                ...
                <div class="col-7 pb-5 text-left ">
                    ...
                    <p class="h6 ">
                        <span class="h3 text-danger mr-3">3.</span> Créez votre compte sur Seller Central, l’interface web sur laquelle vous pourrez aussi gérer votre compte vendeur.
                ...
                <div class="row-sm padding-y-sm bg shadow-lg">
                    ...
                    <div class="col-9 px-5 py-5 ">
                        ...
                        <p>
                            ...
                            <br>
                            <br> Deux façons de répertorier des produits:
                        </p>
                        <div class="ml-5">
                    ...
                    <section class="container  row p-5">
                        ...
                        <div class="col-7 pb-5 text-left ">
                            ...
                            <p class="h6 pt-3 ml-5">
                                ...
                                <ul class="ml-3">
                                    <li>
                                        <p><strong>Outil de gestion des commandes </strong>: visualisez une liste de vos commandes et les détails concernant une commande sélectionnée dans Seller Central.</p>
                                    </li>
                                    <li>
                                        <p><strong>Rapports de commande </strong>: recevez des informations sur le traitement de plusieurs commandes en exécutant un seul rapport.</p>
                                    </li>
                                    <li>
                                        <p><strong>Rapports de commande </strong>: recevez des informations sur le traitement de plusieurs commandes en exécutant un seul rapport.</p>
                                    </li>

<template>
  <div class="page-wrapper">
    ...
    <section>
      ...
      <div class="alert alert danger" v-if="successMessage || serverError">{{ successMessage || serverError }}</div>
      <div class="mx-auto" style="max-width: 1180px; margin-top: 1%">
        <div class="padding-y">
          <div class="row">
            ...
            <!-- col.// -->
            <div class="col-lg-3 col-md-6">
              <article class="card item-pricing mb-3 rounded shadow border border-danger solid">
                <h6 class="card-header">
            ...
            <div class="col-lg-3 col-md-6">
              <article class="card item-pricing mb-3 rounded shadow">
                ...
                <div class="card-body">
                  <p class="price">
                    <strong class="text-danger">> GRATUIT</strong> à vie pour les particuliers
                  </p>
    ...
    planChoosen(data) {
      ...
      this.$store
        ...
        .then((response) => {
          ...
          this.$router.push({ name: "payment", params: {data: response.data.data} });
        }).catch((error) => {
          this.loading = false

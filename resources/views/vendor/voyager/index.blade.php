...
<style type="">
   ...
   .chose4{
        ...
        padding: 8%;
        border-radius: 22px;
        box-shadow: 55px 55px !important;
   } 
   .link, a
   {
        color: white
           ...
           <hr> 
            <div class="row">
              <div class="col-lg-3 col-6 " >
                <!-- small box -->
                <div class="small-box bg-info chose1" >
                  <div class="inner">
                    <h1>@if(\Auth::user()->role_id === 3 )
                            {{ App\Product::where('email', auth()->user()->email)->count() }}
                        @else
                  ...
                  <a href="admin/products" class="small-box-footer ">
                      ...
                      <span class="badge badge-danger m-0 " style="padding: 10px;margin:0px; border-radius: 10px;box-shadow: 2px 2px 6px 2px">Ajouter un produit <i class="fas fa-arrow-circle-right"></i></span>
              ...
              <div class="col-lg-3 col-6">
                <!-- small box -->
                <div class="small-box bg-success chose2">
                  <div class="inner">
                    <h1>@if(\Auth::user()->role_id === 3 )
                        ...
                        @else
                            {{ App\Order::all()->count() }}
                        @endif
                        <!-- <sup style="font-size: 20px">%</sup> --></h1>
                  ...
                  <a href="admin/orders" class="small-box-footer">Voir plus ...<i class="fas fa-arrow-circle-right"></i></a>
                </div>
              </div>
              <!-- ./col -->
              <div class="col-lg-3 col-6">
                ...
                <?php   
                      $countOrder = DB::select("select orders.id, orders.billing_total, count(order_product.order_id) as number from orders INNER join order_product WHERE orders.id = order_product.order_id group by orders.id, orders.billing_total");
                 ...
                 ?>
                <div class="small-box bg-warning chose3">
                  <div class="inner">
                    <h1>@if(\Auth::user()->role_id === 3 )
                            0 Fcfa
                        @else
                            {{ App\Order::where('paymentStatus', !null)->sum('billing_total') }} Fcfa

                        @endif </h1>

<!-- SECTION TOTAL ENCAISSER  -->
                    <h4>Total des gains</h4>
                  </div>
                  <div class="icon">
                    <i class="ion ion-cash-outline"></i><ion-icon name="cash-outline"></ion-icon>
                  </div>
              ...
              <div class="col-lg-3 col-6">
                <!-- small box -->
                <div class="small-box bg-danger chose4">
                  <div class="inner">

 <!-- SECTION TOTAL DES VENTES DE LA BOUTIQUE -->
                    <h1>0<sup style="font-size: 20px"> | Vendue(S)</sup></h1>
        ...
        <div class="analytics-container">
            ...
            @if (isset($google_analytics_client_id) && !empty($google_analytics_client_id))
                ...
                @else
                    <div align="center">
                        <div class="card bg-danger shadow m-3">
                            <h4 class="b  text-light p-3 rounded">{{App\Profile::count()}} Boutiques</h4>
                        </div>
                    </div>

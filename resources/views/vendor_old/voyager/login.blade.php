...
<!-- Bouton d'inscriptiojn d'une nouvelle boutique kalisso -->
            <div  align="right">
                 <a href="/adminSignUp" class="btn btn-block login-button" style="margin-left: 80px; background-color: orange" >
    
                    <span class="signin">Inscription</span>
                 </a>
            </div>
              ...
              @endif
<!-- paragraphe de description de la boutique -->
              <dir>
                  <p>
                      creer votre boutique pour vendre des produits
                  </p>
              </dir>
